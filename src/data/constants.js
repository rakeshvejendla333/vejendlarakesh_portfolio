...
export const experiences = [
  {
    ...
    desc: "A Dot NET engineer with professional expertise in backend and web technologies. Experience with C#, MVC, and SQL Server for creating and managing online services and applications. strong familiarity with backend technologies like caching, messaging queues, and RESTful APIs.",
    skills: ["Postman API", "Microsoft SQL Server ","AngularJS","ASP.NET MVC",
    ],
    doc: "",
  },
  {
